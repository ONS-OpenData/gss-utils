...
#df = pd.read_csv (r'gssutils/csvw/out/air-arrivals-dat.csv')
#df['Air Arrivals'] = df['Air Arrivals'].str.replace("-"," ")
#df['Air Arrivals'] = df['Air Arrivals'].str.title()
#print(df.tail(5))
#cl = CSVCodelists()
#cl.create_codelists(df, 'gssutils/csvw/out')
